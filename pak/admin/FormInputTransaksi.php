  ...
  <div class="cntainer" >
    ...
    <form action="ProsesInsertTransaksi.php" id="form1" method="POST">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-7">
          <input type="text" name="namaUser" class="form-control" id="nama-user" value="Zenudin" readonly>
        </div>
      </div>
      <hr>
      <div class="row">
...
//Akan dijalankan jika recordnya ada while ($row = $result->fetch_assoc()) {
            ...
            <tr>
              ...
              <td><?= $totalHarga; ?></td>
              <td>
                <a onclick="return confirm('Anda yakin akan menghapus record ini?')" class="btn btn-danger" href="pros esDeleteTempTrans.php?id=<?= $row['id_barang'] ?>">
                  Delete
