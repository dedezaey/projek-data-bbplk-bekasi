...
<form action="ProsesInsertTransaksi.php" id="form1" method="POST">
	...
	<div class="form-group row">
		...
		<div class="col-sm-7">
			<input type="text" name="namaUser" class="form-control" id="nama-user" value="rivansyah1" readonly>
		</div>
	</div>
	<hr>
	<div class="row">
		...
		<div class="col-sm-3">
			<input type="submit" name="submitTemp" class="form-control btn btn-success" id="submit-temp" value="Tambah">
		</div>
	</div>
	<hr>
	<!-- Tabel data -->
