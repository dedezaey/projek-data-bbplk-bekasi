			...
			<div class="col-12 col-md-8 col-lg-10 " style="min-height:650px; margin-top: 10px; margin-bottom: 10px; background-image: url(../aset/background.jpg);">
				<div class="container">
					...
					<form action="hasil.php" method="post">
						...
						<input type="text" id="fname" name="Nama Lengkap" placeholder="<?php echo($nama_barang) ?> " readonly>

						<label for="lname">harga barang</label>
						<input type="text" id="lname" name="masukan E-mail" placeholder="<?php echo($harga) ?>" readonly>
						...
						<label class="control-label col-sm-3">Uang Kembali</label>

						<input type="number" name="uangBayar" min="0" class="form-control" id="kembali" readonly>
